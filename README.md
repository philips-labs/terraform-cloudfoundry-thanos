...
| thanos\_image | Image to use for Thanos app. Use a v* tagged version to prevent automatic updates | `string` | `"philipslabs/cf-thanos:v4.0.6"` | no |
| thanos\_memory | Thanos memory | `number` | `1024` | no |
| thanos\_public\_endpoints | Make Thanos public endpoint | `bool` | `false` | no |
| thanos\_query\_image | Image to use for Thanos query. Use a v* tagged version to prevent automatic updates | `string` | `"philipslabs/cf-thanos:v4.0.6"` | no |
| thanos\_store\_disk\_quota | Thanos store disk quota | `number` | `5000` | no |
| thanos\_store\_image | Image to use for Thanos store. Use a v* tagged version to prevent automatic updates | `string` | `"philipslabs/cf-thanos:v4.0.6"` | no |
